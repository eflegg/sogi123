...
function themename_scripts() {
	...
	wp_enqueue_script( 'inclusionbc-navigation', get_template_directory_uri() . '/js/navigation.js', array(), 1.1, true );
	...
	wp_enqueue_style( 'themename-style', get_stylesheet_uri(), 1.1 );
