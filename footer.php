			...
			<div class="inner">
				<div class="support-our-work ">
					<div class="fade-me">
						...
						<a class="button btn--skinny" href='<?php if ($current_lang == 'fr'): echo home_url('/faites-un-don');
																								else: echo home_url('/donate');
																								endif; ?>'><?php echo $donate_label; ?></a>
					</div>
				</div>

				<div class="logo">
					<a href=<?php echo home_url(); ?>>
						<?php include 'components/svg/logo-colour.php'; ?>
					</a>
				</div>
				<div class="footer-nav--container display-flex">
					...
					<div class="socials">
						...
						<div class="social">
							...
							if ($instaLink): ?>
								<a href="<?php echo $instaLink; ?>" target="_blank">
									<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
