...
<div class="share-sidebar <?php echo $sidebarType;?>">
    <div class="share--inner">
        <h3>I'm the share sidebar</h3>
        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh viverra non semper suscipit posuere a pede.  Morbi in sem quis dui placerat ornare. Pellentesque odio nisi euismod in pharetra a ultricies in diam. </p>
        <p class="share-this">Share this with your network:</p>
     

        <div class="socials display-flex">
							<div class="social sidebar"><img src="images/svg/SOGI_white.svg" alt="">
